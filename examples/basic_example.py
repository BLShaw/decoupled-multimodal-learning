...
# - Different datasets demonstrate that the algorithm works on a variety of data distributions
...
for timestep in range(NUM_EXAMPLES):
    ...
    brain.build_nrnd_indexes()  # Rebuild NearestNode indexes (For performance only)
